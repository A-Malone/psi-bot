...
public class GLApp_DemoOrtho extends GLApp {
    ...
    public void setup()
    {
        ...
        sphereTextureHandle = makeTexture("res/images/eye.jpg");

        // Load a cursor image and make it a texture
        cursorTextureHandle = makeTexture("res/images/cursorCrosshair32.gif");

        // Load the image for 2D overlay and make it a texture
        overlayImage = loadImage("res/images/frame_ornate3.gif");

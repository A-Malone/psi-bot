...
public class GLApp_DemoSound extends GLApp {
    ...
    public void setup()
    {
        ...
        sphereTextureHandle = makeTexture("res/images/tree_frog_1_512.jpg");

        // Create texture and mipmap for marble sphere
        marbleTextureHandle = makeTexture("res/images/marble.jpg");

        // Create texture with anisotropic filtering and mipmap for ground plane
        groundTextureHandle = makeTexture("res/images/grass_1_512.jpg", true, true);
        ...
        int frogSample = SoundScape.loadSoundData("res/sounds/frog.wav");
        int cyberSample = SoundScape.loadSoundData("res/sounds/steam_loop.wav");  //jet_cruising_loop_1.wav"); //

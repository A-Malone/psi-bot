...
//    		}
    ...
    public static void demo() {
        ...
        soundDataA = loadSoundData("res/sounds/cardinal3.wav");
        soundDataB = loadSoundData("res/sounds/bomb.wav");
     ...
     */
    public static int loadSoundData(String soundFilename) //, int soundDataBufferHandle)
    {
